...
const routes = {
  day1: [
    ...
    },
    {
      ...
      name: "阿昌豆浆炒",
      query: "阿昌豆浆炒 莆田",
      note: "第一段午餐先吃豆浆炒，点小份尝味道；可顺手加甜麦煎或煎粿，给后面的扁食和泗粉留胃口。",
      x: 52,
      y: 88,
      mode: "walking",
    },
    ...
    },
    {
      ...
      note: "四果汤推荐这家，放在广化寺后面补清爽甜口；也可点仙草类甜品，第一天喝过第二天就不用重复。",
      x: 68,
      y: 22,
      mode: "driving",
    },
    ...
    },
    {
      ...
      name: "老蒲鲜·地标·非遗美食",
      mapLabel: "老蒲鲜正餐",
      query: "老蒲鲜 地标 非遗美食 一中总店 莆田",
      note: "莆田菜集合店选老蒲鲜：必点红菇卤面、焖豆腐、南乳荔枝肉、头水紫菜焖海蛎或紫菜焖饭，再看胃口加兴化炒米粉。",
      x: 60,
      y: 50,
      mode: "driving",
    },
    {
      ...
      name: "伴手礼补货",
      mapLabel: "糕饼伴手礼",
      query: "莆田 枫亭糕 赤饼 伴手礼 特产店",
      note: "第一天先把可打包的糕饼买好：枫亭糕、赤饼优先；如果现场不好找，就在老城或酒店附近搜特产店。",
      x: 14,
      y: 44,
      mode: "driving",
    },
  ...
  day2: [
    ...
    },
    {
      ...
      mapLabel: "糖阿酸",
      query: "糖阿酸 阿酸糖水铺 莆田总店 东大路542弄",
      note: "四果汤补漏推荐这家；也可补仙草类甜品。如果第一天已经喝过，就把这一站跳过，直接回酒店取行李。",
      x: 56,
      y: 82,
      mode: "walking",
    },
